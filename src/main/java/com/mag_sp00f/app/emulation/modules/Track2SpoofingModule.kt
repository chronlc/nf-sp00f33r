...
class Track2SpoofingModule : EmvAttackModule {
    ...
    private var configuration = mutableMapOf<String, Any>(
        ...
        "target_pan" to "5555555555554444", // Default to MasterCard test
        "target_expiry" to "2512", // Dec 2025
    ...
    /**
     * Validate Luhn checksum for PAN
     */
